    ...
    <div class="col-9">
        <form id="form" method="post">
            ...
            <div class="invalid">
                ...
                <input type="text" id="idAdresse" name="adresse" placeholder="votre adresse"/>
                ...
                <label for="idcode_postal" id="code">Code Postal: </label>
                <input type="text" id="idcode_postal" name="idcode_postal" maxlength="5" size="6"/>
            </div>
            <div class="submit">
