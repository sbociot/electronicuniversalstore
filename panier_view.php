        ...
        <form class="panier_action" method="post">
            ...
            <?php foreach ($panier as $article_id => $article) { ?>
                    <tr>
                        ...
                        <td><span class="panier_article_quantite"><?= $article[PS_PANIER_ITEM_NAME]?></span></td>
                        <td><span class="panier_article_name"><?= $article[PS_PANIER_ITEM_QTY]?></span></td>
                        <td><span class="panier_article_quantite"><?= $article[PS_PANIER_ITEM_PRIX]?></span></td>
